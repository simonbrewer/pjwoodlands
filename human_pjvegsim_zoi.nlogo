...
people-own [ energy ]  ; turtles own energy which they harvest from patches
...
to go
  if ticks = 500 [ ;; Allow a few hundred ticks to spin up
    create-people 10 ; will vary later with slider
    [
      set shape "person"
...
to harvest-trees
  show "TREES?? OMG!!!"
  ask [trees-on-me] of patch-here
  [
    if dead? [
      ;set [energy] of myself 100
